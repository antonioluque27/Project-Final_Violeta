...
if st.button('Check Specifications'):
	...
	if is_type == "Wind Turbines":
		st.write('''
  "Wind Turbine Type:" + str(taula_WT['Wind Turbine'])\n
  "Prated:"+ str(taula_WT['Prated'])\n
  "Swept area:" + str(taula_WT['Swept area'])\n
  "Angle Transmission:" + str(taula_WT['Angle Transmission'])\n
  "Cut-in/Cut-out wind speed:"+ str(taula_WT['Cut-in/Cut-out wind speed'])\n
  "Operational data:"+ str(taula_WT['Operational data'])''')
...
####--Create a Figure to be added 
        plt.figure(constrained_layout=True, figsize =(5, 4.5))
