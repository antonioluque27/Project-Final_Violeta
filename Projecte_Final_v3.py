...
# =============================================================================
        if is_wind == "Active Power":
            text_P = st.write('''Procedure: , "• Measurements shall be sampled during continuous operation only.", "• The active and reactive power shall be measured at the WT's terminals.",
